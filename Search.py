...
from robot.matteobot import evaluate as matteoevaluate
...
def basicbot_evaluate(robot, world, sim_step, info):
  stime = time.time()
  world.restart()
...
def evaluate(botType, robot, world, sim_step, info):
    if botType=="basicrobot":
      return basicbot_evaluate(robot, world, sim_step, info)
    if botType=="matteobot":
      return matteoevaluate(robot, world, sim_step, info)
